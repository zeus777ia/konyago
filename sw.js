/* KonyaGo SW v11 — mobil hız */
var CACHE = "konyago-v11";
var PRECACHE = [
  "./",
  "./index.html",
  "./assets/css/app.css",
...
self.addEventListener("fetch", function (e) {
  ...
  var isAsset = /\.(svg|png|jpg|jpeg|webp|woff2?)$/i.test(path);

  // HTML + CSS/JS: network-first, cache fallback (güncel kalsın)
  if (isHTML || isCode) {
    e.respondWith(
      fetch(e.request)
        .then(function (res) {
  ...
  // Statik görseller: cache-first (mobil veri tasarrufu)
  if (isAsset) {
    e.respondWith(
