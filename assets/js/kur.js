...
(function (w, d) {
  ...
  /* Radyo askida — eski buton/mini player kaldir */
  function stripRadio() {
    d.querySelectorAll("a.social-btn.radyo, #kgMiniRadio, #kgHomeAudio, #kgRadioCta").forEach(function (n) {
      n.remove();
    });
    d.querySelectorAll('a[href="radyo.html"]').forEach(function (a) {
      if (a.classList.contains("nav-link") || a.closest("nav")) a.remove();
      else if (a.classList.contains("social-btn")) a.remove();
    });
  }
